...
const Contact = () => {
  return (
    <section id="contact" class="relative w-full min-h-screen bg-black text-yellow-400">
    <h1 class="text-4xl pt-12 text-center px-6 pb-12 font-bold tracking-wide text-yellow-400">
        Contact Us
    </h1>
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-yellow-400 h-32 w-full"></div>
    ...
    <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
        ...
        <div class="bg-gray-900 border border-yellow-400 w-full lg:w-1/2 h-full p-5 pt-8">
            <h3 class="text-2xl font-semibold mb-5">
            My Social Media
            </h3>
            <div class="flex flex-col gap-3">
            <a href="#" class="flex items-center hover:text-white hover:bg-yellow-400 p-2">
        ...
        <form action="#" class="w-full md:w-1/2 border border-yellow-400 p-6 bg-gray-900">
        ...
        <div>
            ...
            <input 
                type="text" id="name" 
                class="px-3 py-2 bg-gray-800 border border-gray-900 focus:border-yellow-400 focus:outline-none focus:bg-gray-800 focus:text-yellow-400"
                autocomplete="off"
            />
            </div>
            <div class="flex flex-col mb-3">
        ...
        <div class="w-full pt-3">
            <button type="submit" class="w-full bg-gray-900 border border-yellow-400 px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-yellow-400 hover:text-white text-xl cursor-pointer">
            Send
            </button>
        </div>
        </form>
